...
function getAnnouncements( $style = "html" ) {
	...
	$query = "SELECT n.nid, n.title, a.isodate AS _date from node n JOIN node_revisions v ON (n.vid=v.vid) JOIN clickpdx_iso_announcement_date a ON(n.vid=a.vid) WHERE n.status=1 ORDER BY _date DESC LIMIT 10";
