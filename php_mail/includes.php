...
function getAnnouncements( $style = "html" ) {
	...
	$query = "SELECT n.nid, n.title, a.field_date_value AS _date from node n JOIN node_revisions v ON (n.vid=v.vid) JOIN content_type_announcement a ON(n.vid=a.vid) WHERE n.status=1 ORDER BY n.nid DESC LIMIT 10";
