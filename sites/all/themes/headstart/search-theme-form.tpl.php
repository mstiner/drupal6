...
<?php print str_replace("Search this site:",'',$search['search_theme_form']);?><input id="input-image" type="image" src="/sites/all/themes/headstart/images/search_input.png" value="Search this site" border="0" />
</div>
